      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex items-center space-x-5">
            ...
            <Link href="/carrito" className="text-gray-600 hover:text-mosqueta-primary transition-colors relative" aria-label="Carrito">
            ...
            <button className="text-gray-600 hover:text-mosqueta-primary md:hidden" aria-label="Menú">
